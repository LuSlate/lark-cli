...
def instruction_payload(*, prompt: str, language: str, target_slide_count: int, audience: str) -> dict[str, Any]:
    return {
        ...
        "must_avoid": [
            "do not invent a confirmed SpaceX IPO date",
            "do not present private-company valuation assumptions as facts",
...
def build_source_prompt(instruction: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            "For SpaceX IPO analysis, avoid claiming a confirmed IPO date unless explicitly sourced; mark uncertainties as analysis context.",
            "",
            "Instruction:",
...
def build_deck_prompt(instruction: dict[str, Any], context: dict[str, Any]) -> str:
    ...
    return "\n\n".join(
        [
            ...
            "For this topic, build a complete investment-analysis deck narrative without inventing a confirmed IPO date.",
...
def build_slide_prompt(instruction: dict[str, Any], deck_plan: dict[str, Any], context: dict[str, Any], deck_sha: str) -> str:
    ...
    return "\n\n".join(
        [
            ...
            "Use varied page shapes for SpaceX IPO analysis. Include at least one image-feature page and one data-story or risk-alert page.",
...
def build_canvas_prompt(instruction: dict[str, Any], deck_plan: dict[str, Any], slide_plan: dict[str, Any], context: dict[str, Any]) -> str:
    ...
    bundle = {
        ...
        "content_key_guidance": {
            ...
            "data-story": ["title", "subtitle", "metrics", "callout"],
