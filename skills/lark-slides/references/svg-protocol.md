...
>
  <rect slide:role="shape" x="80" y="80" width="320" height="180" fill="#E8EEF8" />
  <foreignObject slide:role="shape" slide:shape-type="text" x="120" y="130" width="320" height="80">
    <p xmlns="http://www.w3.org/1999/xhtml">SVGlide</p>
  </foreignObject>
  <image slide:role="image" href="@./hero.png" x="520" y="80" width="320" height="180" />
</svg>
```
...
```xml
<image slide:role="image" href="@./background.jpg" x="0" y="0" width="1280" height="720" />
```
