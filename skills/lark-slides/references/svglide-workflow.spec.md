...
| contract_compile | raw visual manifest or legacy direct SVG, assets map and asset manifest | ordered `04-svg/page-###.svg`, `04-svg/contract/page-###.report.json`, `04-svg/contract/manifest.json`, `receipts/contract_compile.json` | only this node injects SVGlide/Slides private protocol for artboard mode; output/report/manifest hashes and asset injection summary must be current |
