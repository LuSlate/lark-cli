...
| quality_gate | generator receipt, preflight, preview lint, aesthetic review, chart verify, semantic review, runtime review, source/assets readiness | `06-check/quality-gate.json` | required checks must all pass and be fresh before dry-run or live create; strict profiles reject blocked research and failed asset manifests |
